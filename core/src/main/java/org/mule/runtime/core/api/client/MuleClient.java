...
public interface MuleClient
{
    ...
    /**
     * Processes a message with an outbound endpoint using the specified {@link MessageExchangePattern}
     * 
     * @param uri
     * @param mep the {@link MessageExchangePattern} that should be used
     * @param payload the message payload
     * @param messageProperties and message properties that should be used (optional, use null otherwise)
     * @return the result of endpoint invocation if the {@link MessageExchangePattern} defines a response else null.
     * @throws MuleException
     */
    ...
    /**
     * Processes a messsage with an outbound endpoint using the specified {@link MessageExchangePattern}
     * 
     * @param uri
     * @param mep the {@link MessageExchangePattern} that should be used

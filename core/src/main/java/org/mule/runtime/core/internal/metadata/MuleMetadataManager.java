...
public class MuleMetadataManager implements MetadataManager, Initialisable
{
     ...
     */
    @Override
    public MetadataResult<MetadataKeyDescriptor> getMetadataKeyChildren(ComponentId componentId, MetadataKey partial)
    {
        return exceptionHandledMetadataFetch(componentId, processor -> processor.getMetadataKeyChildren(partial), EXCEPTION_RESOLVING_METADATA_KEYS);
    }

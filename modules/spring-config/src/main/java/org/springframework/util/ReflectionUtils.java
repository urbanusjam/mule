...
/**
 * TODO: MULE-8817 {@link #clearCache()} method was added in spring 4.2.4, so we have to include this here. Simple
 * utility class for working with the reflection API and handling reflection exceptions.
 *

...
import static org.mule.runtime.module.extension.internal.util.IntrospectionUtils.getMetadataKeyPartFields;
...
public final class MuleExtensionAnnotationParser
{
     ...
     * annotated either as {@link Content} or {@link MetadataKeyId}
     ...
     */
    public static void parseMetadataAnnotations(AnnotatedElement element, Class elementType, HasModelProperties elementWithModelProperties)
    {
        elementWithModelProperties.withModelProperty(new MetadataModelProperty(element.isAnnotationPresent(MetadataKeyId.class),
                                                              element.isAnnotationPresent(Content.class),
                                                              getMetadataKeyPartFields(elementType).size()));
    }
}

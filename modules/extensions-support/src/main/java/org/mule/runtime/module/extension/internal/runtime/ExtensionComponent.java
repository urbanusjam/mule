...
public abstract class ExtensionComponent implements MuleContextAware, MetadataAware, FlowConstructAware, Initialisable
{
     ...
     */
    @Override
    public MetadataResult<MetadataKeyDescriptor> getMetadataKeyChildren(MetadataKey key) throws MetadataResolvingException
    {
        return metadataMediator.getMetadataKeyChildren(getMetadataContext(), key);
    }
